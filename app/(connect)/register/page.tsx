      ...
      <div className="w-full max-w-[400px] p-8 md:p-10 rounded-2xl shadow-2xl bg-background/80 backdrop-blur-xl border border-white/10 flex flex-col gap-8 relative z-10 transition-all duration-300 hover:shadow-primary/5 ring-1 ring-white/5">
        <div className="flex flex-col items-center">
          <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-primary"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="8.5" cy="7" r="4" /><line x1="20" x2="20" y1="8" y2="14" /><line x1="23" x2="17" y1="11" y2="11" /></svg>
          </div>
        ...
        <div className="text-center text-sm text-muted-foreground">
          ...
          <a href={ROUTES.LOGIN} className="text-primary font-medium hover:text-primary/80 transition-colors">
            Sign in
          </a>
        </div>
      </div>
